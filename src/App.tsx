        ...
        <div className="bg-amber-500/10 border-y border-amber-500/30 py-4">
          <div className="container mx-auto px-6 flex flex-col items-center justify-center gap-2 text-center">
            ...
            <p className="text-sm sm:text-base font-semibold text-foreground">
              ...
              <span className="text-amber-600 font-black">April 14–17, 2026</span> due to pending due diligence and limited airplane ticket availability caused by the upcoming Holy Week.
            </p>
          </div>
        </div>
