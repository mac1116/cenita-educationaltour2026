...
export function DonorsSection() {
  ...
  const topDonors = [
    { rank: 1, name: 'K******Y  S.', amount: 1000, icon: Trophy, color: 'from-amber-500 to-amber-600' },
    { rank: 2, name: 'Bank Transfer from BDO Unibank Inc. with account ending in 2368', amount: 350, icon: Medal, color: 'from-slate-400 to-slate-500' },
    { rank: 3, name: 'SU****E G.', amount: 500, icon: Award, color: 'from-amber-700 to-amber-800' },
    { rank: 4, name: 'BERNARDITA CABATUAN', amount: 200, icon: Star, color: 'from-teal-500 to-teal-600'},
    { rank: 5, name: 'RO***T JH*N A.', amount: 5, icon: Star, color: 'from-slate-600 to-slate-700' },
    { rank: 6, name: 'LO**E J** M.', amount: 1, icon: Star, color: 'from-cyan-600 to-cyan-700' },
  ]
