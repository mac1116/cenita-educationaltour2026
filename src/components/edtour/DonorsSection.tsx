...
export function DonorsSection() {
  ...
  const topDonors = [
    ...
    { rank: 5, name: 'K******Y  S.', amount: 1000 },
    { rank: 6, name: 'M** GI*A O', amount: 800 },
    { rank: 7, name: 'SU****E G.', amount: 500 },
    { rank: 8, name: 'R****N A**B', amount: 500 },
    { rank: 9, name: 'Bank Transfer from BDO Unibank Inc. with account ending in 2**8', amount: 350 },
    { rank: 10, name: 'B********A C******N', amount: 200 },
    { rank: 11, name: 'KE**N JO*N A.', amount: 10 },
    { rank: 12, name: 'RO***T JH*N A.', amount: 5 },
    { rank: 13, name: 'LO**E J** M.', amount: 1 },
  ]
