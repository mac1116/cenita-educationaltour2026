...
export function DonorsSection() {
  const topDonors = [
    ...
    { rank: 2, name: 'Bank Trasnfer from BDO Unibank.Inc. with account ending in 2368', amount: 350, icon: Medal, color: 'from-gray-300 to-gray-400' },
    { rank: 3, name: 'BERNARDITA CABATUAN', amount: 200, icon: Award, color: 'from-amber-600 to-amber-700' },
    { rank: 4, name: 'LO**E J** M.', amount: 1, icon: Star, color: 'from-blue-400 to-blue-500' },
